...
for i in range(10):
    ...
    if step_count <= 75:
        completed_time.append(f"mountain was completed in 75 or less steps on run {len(steps_taken)}")

#print out results
print(f"the amount of runs that passed the parameters were {len(completed_time)} \n")
